...
abstract: In this tutorial we illustrate the effectiveness of the PSY procedure in                  detecting crisis with an applications to the European Sovereign Sector using           R and the *psymonitor* package.
---
...
bubbleDates <- disp(OT)
kable(bubbleDates, caption = "Crisis Periods in the European Soevereign Debt Market")
```
...
```{r dateStampPlot, echo=FALSE, fig.width=8,fig.height=5,warning=FALSE}
